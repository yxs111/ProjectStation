...
<head>
  ...
  <link rel="stylesheet"
    ...
    <script>
        function deleteC(id){
            location.href="${pageContext.request.contextPath}/science/deleteScience?id="+id;
            alert("删除成功！")
            return false;
        }
    </script>
                ...
                <div class="col-xs-12">
                    <div class="box">
                        <div class="box-header">
                            <h3 class="box-title"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">技术类型信息表</font></font></h3>
                        </div>
                        <!-- /.box-header -->
                        <div class="box-body">
                            <div id="example1_wrapper" class="dataTables_wrapper form-inline dt-bootstrap">
                                <div class="row">
                                    <div class="col-sm-12">
                                        ...
                                        <div class="row">
                                            <div class="col-md-4">
                                                <button type="button" class="btn btn-info" onclick="location.href='${pageContext.request.contextPath}/science/showScience?id='+0">添加</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div  style="margin-top:20px;" >
                                    <form action="${pageContext.request.contextPath}/science/addScience" id="deleteForm" method="post">
                                        <table class="table table-bordered table-hover table-striped" style="text-align:center;table-layout: fixed;">
                                            ...
                                            <tbody>
                                            <c:forEach items="${scienceList}" var="science" varStatus="var">


                                                <tr>
                                                    <td style="padding-top:20px"><input type="checkbox" name="ids" value="${science.id}"/></td>
													<td style="padding-top:20px">${var.count}</td>
													<td style="padding-top:20px">${science.scienceName}</td>
                                                    <td style="padding-top:20px"><a href="${pageContext.request.contextPath}/science/showScience?id=${science.id}"><span class="glyphicon glyphicon-edit"></span></a></td>
                                                    <td style="padding-top:20px"><a href="#" onclick="return deleteC(${science.id})" ><span class="glyphicon glyphicon-trash"></span></a></td>
                                                </tr>
                                            </c:forEach>
