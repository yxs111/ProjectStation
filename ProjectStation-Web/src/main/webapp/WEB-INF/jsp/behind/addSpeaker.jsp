                        ...
                        <div class="container" style="margin-top: 20px;">
                            ...
                            <form class="form-horizontal" action="${pageContext.request.contextPath}/speaker/saveOrUpdate" method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" name="speakerName" placeholder="" value="${speaker.speakerName}">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-2 control-label">讲师职务</label>
                                    <div class="col-sm-10">
                                        <div class="input-group">
                                            <div class="input-group-btn">
                                                ...
                                                <ul id="ul_2" class="dropdown-menu">
                                                    <c:forEach items="${jobList}" var="job">
                                                        <li value="${job.id}"><a onclick="showcName(this,${job.id})">${job.jobName}</a></li>
                                                    </c:forEach>
                                                </ul>
                                            </div>
                                            <input type="hidden" class="form-control" id="scienceId" name="jobId" value="${speaker.jobId}">
                                            <input type="text" class="form-control" id="scienceName" name="jobName" value=""/>
                                        </div><!-- /input-group -->
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-2 control-label">讲师头像</label>
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" name="speakerImgUrl" placeholder="" value="${speaker.speakerImgUrl}">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-2 control-label">讲师QQ</label>
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" name="qqQrCode" placeholder="url" value="${speaker.qqQrCode}">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-2 control-label">讲师微信</label>
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" name="vxQrCode" placeholder="url" value="${speaker.vxQrCode}">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-2 control-label">讲师介绍</label>
                                    <div class="col-sm-10">
                                        <textarea class="form-control" name="speakerDetail" rows="3">${speaker.speakerDetail}</textarea>
                                    </div>
                                </div>
                                <div class="form-group">
