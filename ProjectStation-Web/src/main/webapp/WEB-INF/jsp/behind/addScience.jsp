          ...
          <div class="box">
            <div class="box-header">
              <h3 class="box-title"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">
				<c:if test="${empty science.id}">
            <h4>添加商品类型</h4>
        </c:if>
        <c:if test="${not empty science.id}">
            <h4>修改商品类型</h4>
        </c:if></font></font></h3>
            </div>
<div class="container" style="margin-top: 20px;">
    <!--enctype="multipart/form-data"-->
    <form class="form-horizontal" action="${pageContext.request.contextPath}/science/addScience" method="post">
        <c:if test="${not empty science.id}">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <input type="text" class="form-control" name="scienceName" placeholder="名称" value="${science.scienceName}">
            </div>
        </div>
        <div class="form-group">
