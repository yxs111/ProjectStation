...
<head>
    ...
    <script type="text/javascript">
        ...
        function showcName(obj, id) {
            ...
            document.getElementById("scienceName").value = courseName;
            document.getElementById("scienceId").value = id;
            //alert(document.getElementById("typeId").value);
        }

       window.onload=function () {
           var speakerId = '${project.speakerId}';
           ...
           var scienceId = '${project.scienceId}';
           $("#ul_2 li").each(function () {
               //alert("scienceId")
               if ($(this).val() == scienceId) {
                   $("#scienceName").val($(this).text());
                ...
                <div class="col-xs-12">
                    <div class="box">
                        ...
                        <div class="container" style="margin-top: 20px;">
                            ...
                            <form class="form-horizontal" action="${pageContext.request.contextPath}/project/addProject" method="post">
                                <c:if test="${not empty project.id}">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" name="projectName" placeholder="请一个靓名" value="${project.projectName}">
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <div class="input-group">
                                            <div class="input-group-btn">
                                                ...
                                                <ul id="ul_1" class="dropdown-menu">
                                                    <c:forEach items="${speakerList}" var="speaker">
                                                        <li value="${speaker.id}"><a onclick="showsName(this,${speaker.id})">${speaker.speakerName}</a></li>
                                                    </c:forEach>
                                                </ul>
                                            </div>
                                            <input type="hidden" class="form-control" id="speakerId" name="speakerId" value="${speaker.speakerId}">
                                            <input type="text" class="form-control" id="speakerName" value=""/>
                                        </div><!-- /input-group -->
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-2 control-label">技术选型</label>
                                    <div class="col-sm-10">
                                        <div class="input-group">
                                            <div class="input-group-btn">
                                                <button type="button" class="btn btn-default dropdown-toggle" data-toggle="dropdown"
                                                        aria-haspopup="true" aria-expanded="false">下拉菜单<span class="caret"></span></button>
                                                <ul id="ul_2" class="dropdown-menu">
                                                    <c:forEach items="${scienceList}" var="science">
                                                        <li value="${science.id}"><a onclick="showcName(this,${science.id})">${science.scienceName}</a></li>
                                                    </c:forEach>
                                                </ul>
                                            </div>
                                            <input type="hidden" class="form-control" id="scienceId" name="scienceId" value="${science.scienceId}">
                                            <input type="text" class="form-control" id="scienceName" value=""/>
                                        </div><!-- /input-group -->
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" name="projectImgUrl" placeholder="请一个靓名" value="${project.projectImgUrl}">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-2 control-label">项目网址</label>
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" name="projectUrl" placeholder="请一个靓名" value="${project.projectUrl}">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-2 control-label">项目介绍</label>
                                    <div class="col-sm-10">
                                        <textarea class="form-control" name="ProjectDetail" rows="3">${project.projectDetail}</textarea>
                                    </div>
                                </div>
                                <div class="form-group">
